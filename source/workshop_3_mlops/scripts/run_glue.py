...
class DataTrainingArguments:
    ...
    def __post_init__(self):
        print(os.listdir('/opt/ml/input/data/test/'))
...
#     print('************************************',training_args.do_train)
    ...
    label2id_new, id2label_new = dict(), dict()
    for i, label in enumerate(label_list):
        label2id_new[label] = str(i)
        id2label_new[str(i)] = label
    ...
    model = AutoModelForSequenceClassification.from_pretrained(
        ...
        num_labels=num_labels, label2id=label2id_new, id2label=id2label_new,
        cache_dir=model_args.cache_dir,
        revision=model_args.model_revision,
        use_auth_token=True if model_args.use_auth_token else None,
    )
